...
static void vSensorTask(void* /*pvParameters*/) {
    ...
    while (true) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            if (isnan(ah)) {
                ...
                DEV_DBG_PRINTLN("Sensor " ); DEV_DBG_PRINTLN(i); // lightweight debug
                continue;
            }
    ...
    DEV_DBG_PRINT(" Δ: "); DEV_DBG_PRINT(g_dhtAHDiff[0], 2); DEV_DBG_PRINT(" "); DEV_DBG_PRINTLN(g_dhtIsWet[0] ? "WET" : "DRY"); taskYIELD();
    ...
    DEV_DBG_PRINT(" Δ: "); DEV_DBG_PRINT(g_dhtAHDiff[1], 2); DEV_DBG_PRINT(" "); DEV_DBG_PRINTLN(g_dhtIsWet[1] ? "WET" : "DRY"); taskYIELD();
